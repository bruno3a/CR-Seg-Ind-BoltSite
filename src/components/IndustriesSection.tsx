...
const IndustriesSection = () => {
    ...
    return (
        <section className="w-2/5 py-8 bg-gradient-to-b from-gray-100 to-gray-50">
            <div className="px-4">
                ...
                <div className="relative h-[748px] overflow-hidden industries-carousel"> {/* 11 filas * 68px */}
                    ...
                    >
                        <div className="grid grid-cols-2 gap-3"> {/* Aumentado el gap a 3 para más espacio entre cards */}
                            {duplicatedIndustries.map((industry, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative h-full px-4 flex items-center justify-between"> {/* Aumentado el padding horizontal */}
                                            <h3 className="text-base font-semibold text-white truncate"> {/* Aumentado el tamaño de fuente */}
                                                {industry.name}
                                            </h3>
                                            <Icon className="w-5 h-5 text-blue-400 flex-shrink-0 ml-3" /> {/* Aumentado el tamaño del ícono */}
                                        </div>
                                    </div>
                                );
                            })}
